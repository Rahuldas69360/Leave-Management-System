<?php
	...
	if(isset($_POST['apply'])){
		...
		if(($cl<$days)){
			$msgCl="Please check available casual leave.";
			}
			else{
				$cl=($cl-$days);	
				$query = "INSERT INTO allleave(id,name,type,start_date,end_date,days,reason,status) VALUES ('$id','$name','Casual Leave','$sdate','$edate','$days','$reason','Applied')";
				$res=mysqli_query($con,$query);
				if($res==true){
					$up = "UPDATE empregis SET cl='$cl' where id='$id'";
					mysqli_query($con,$up);
					echo'<script type="text/javascript">
					window.alert("Your casual leave application has been applied")</script>';
				}
				else
				{
				echo'<script type="text/javascript">
...
<body>
  ...
  <div class="leaveApply">
  	<h2 align="center">Selected Type: <b>Casual Leave</b></h2>
	<p>Casual Leave Available: 
	...
	<table align="center">
		...
		<tr>
			...
			<td style="color:red; text-align:center"><?php echo $msgCl;?></td>
		</tr>
		<tr>
